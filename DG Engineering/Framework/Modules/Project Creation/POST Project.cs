...
" + e, @"Error");
        ...
        private void CreateFolderStructure()
        {
            ...
            Directory.CreateDirectory(Path.Combine(DGEngineering, "DG Engineering HUB - Operations", "Jobs", ProjectJobNumber.Text + " - " + modifiedname, "OHS (JHA-Risk Assessments-Incidents-Investigations)"));
            ...
            Directory.CreateDirectory(Path.Combine(DGEngineering, "DG Engineering HUB - Operations", "Jobs", ProjectJobNumber.Text + " - " + modifiedname, "OHS (JHA-Risk Assessments-Incidents-Investigations)", "JHA Records"));
            Directory.CreateDirectory(Path.Combine(DGEngineering, "DG Engineering HUB - Operations", "Jobs", ProjectJobNumber.Text + " - " + modifiedname, "OHS (JHA-Risk Assessments-Incidents-Investigations)", "Risk Assessments"));
            Directory.CreateDirectory(Path.Combine(DGEngineering, "DG Engineering HUB - Operations", "Jobs", ProjectJobNumber.Text + " - " + modifiedname, "OHS (JHA-Risk Assessments-Incidents-Investigations)", "Incidents"));
            Directory.CreateDirectory(Path.Combine(DGEngineering, "DG Engineering HUB - Operations", "Jobs", ProjectJobNumber.Text + " - " + modifiedname, "OHS (JHA-Risk Assessments-Incidents-Investigations)", "Investigations"));
            DownloadDocument();
        }
    }
}