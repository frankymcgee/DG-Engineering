...
namespace DG_Engineering.Framework.Global.MYOB
{
    internal class Jobs
    {
        ...
        public class Item
        {
            ...
            [JsonProperty("IsHeader")] public bool IsHeader { get; set; }

            [JsonProperty("Name")] public string Name { get; set; }

            [JsonProperty("Description")] public string Description { get; set; }

            [JsonProperty("ParentJob")] public ParentJob ParentJob { get; set; }

            [JsonProperty("LinkedCustomer")] public LinkedCustomer LinkedCustomer { get; set; }

            [JsonProperty("PercentComplete")] public double PercentComplete { get; set; }

            [JsonProperty("StartDate")] public DateTime? StartDate { get; set; }

            [JsonProperty("FinishDate")] public object FinishDate { get; set; }
            ...
            [JsonProperty("TrackReimbursables")] public bool TrackReimbursables { get; set; }
